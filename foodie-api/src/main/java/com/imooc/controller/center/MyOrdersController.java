...
public class MyOrdersController extends BaseController {
    ...
    @ApiOperation(value = "查询订单状态数概况", notes = "查询订单状态数概况", httpMethod = "POST")
    ...
    public IMOOCJSONResult statusCounts(
        ...
        OrderStatusCountsVO statusCountsVO = myOrdersService.getOrderStatusCounts(userId);

        return IMOOCJSONResult.ok(statusCountsVO);
    }
